  ...
  Widget build(BuildContext context) {
    return Consumer(
      builder: (context, ref, _) {
        ...
        _special = specialVM.specialsList
            .firstWhere((special) => special.uuid == widget.special.uuid);
        return Column(
          children: [
            Row(
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          _statCard(
                            title: "Phone Clicks",
                            number: _special.phoneClicks,
                          ),
                          _statCard(
                            title: "Saved Clicks",
                            number: _special.savedClicks,
                          ),
                        ],
                      ),
                      const SizedBox(
                      ...
                      Row(
                        children: [
                          ...
                          _statCard(
                            title: "Shared Clicks",
                            number: _special.shareClicks,
                          ),
                          _statCard(
                            title: "Website Clicks",
                            number: _special.websiteClicks,
                          ),
