...
class _SpecialCardState extends State<SpecialCard> {
  ...
  void initState() {
    ...
    final storesViewModel = context.read(storesVMProvider);
      ...
      return GestureDetector(
        onTap: () async {
          ...
          _specialsViewModel.addSpecialStatIncrement(
              _special.uuid, SpecialStat.click);
          ...
          IconButton(
            ...
            onPressed: () async {
              ...
              try {
                ...
                await launch("tel:${_special.storePhoneNumber.trim()}");
              } catch (e) {
          ...
          IconButton(
            ...
            onPressed: () async {
              ...
              try {
                ...
                InfoSnackBar.show(
                    context, "Error opening ${_special.storeWebsite}",
                    color: SnackBarColor.error);
                print(e);
              }
            },
