      ...
      child: Consumer(
          builder: (context, watch, child) {
            ...
            return Column(
              ...
              children: <Widget>[
                TextFormField(
                  validator: (value) { return value == null || value.isEmpty ? kFieldNotEnteredMessage : null; },
                  ...
                  child: Row(
                    ...
                    children: [
                      Checkbox(
                          ...
                          value: _termsCheck,
                          onChanged: (checked) => checked != null ?  setState((){_termsCheck = checked;}) : null
                      ),
                  ...
                  child: Row(
                    ...
                    children: [
                      Checkbox(
                          ...
                          checkColor: Colors.white,
                          value: _ageCheck,
                          onChanged: (checked) => checked != null ? setState((){_ageCheck = checked;}) : null
                      ),
                      const SizedBox(width: 8.0,),
                ...
                Builder(
                  builder: (context) =>
                      ElevatedButton(
                        onPressed: () async {
                          print("CALLED PG");
                          if (!_termsCheck) InfoSnackBar.show(context, "Please confirm you have read the terms and conditions", color: SnackBarColor.error, );
                          if (!_ageCheck) InfoSnackBar.show(context, "Please confirm you are over the age of 13 years", color: SnackBarColor.error, );
