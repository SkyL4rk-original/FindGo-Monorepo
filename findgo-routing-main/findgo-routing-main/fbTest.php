<?php
	...
	*/
	...
	//$result = $db->query("
		//SELECT firebaseToken FROM user
	...
	array_push($firebaseTokenList, "diBR3b18RyeMZuqVxLoPp-:APA91bHVZVzIp0WfVtM_tgp0FeuE6IP3xCqmm1oEiFBxPsG0RjytVEbq4IRDAS_VzrW4boPb6_rD0FuMkXDDFwPuseKiXE-KoBWJXbjWt4cORr7nUBFE_zHUe7V1fdz01k7SfpRz5xC0");
	array_push($firebaseTokenList, "dGIhudK2d0XqujZTABJTTz:APA91bEtDiZ0R6lrK1lwd8R1VW-cw-j3hNYW0qePEaTk8ho4f9SDT69LKo6h5nDMLBHBokGvIG6Rgo7115QzWhyNFxeuq0nTQmgCp9EBEwkDRk7ghtO5EZdm4AOyxcy1CM5RaUbIQJzn");
	...
	// Remove duplicate tokens so user doesnt recive two notifications
	$firebaseTokenList = array_unique($firebaseTokenList);
